      ...
      <div className="flex items-center justify-between px-4 sm:px-6 py-3">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Link to="/" className="hidden lg:flex items-center gap-2 p-2 rounded-lg hover:bg-white/10 text-white/50 hover:text-primary-400 transition-colors" title="Go to Home">
              <FiGlobe size={18} />
