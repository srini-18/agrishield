        ...
        <div className="glass-card p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  <input 
                    ...
                    className={`input-field pl-14 text-sm ${errors.phone ? 'border-red-500/50' : ''}`} 
            ...
            <div>
              ...
              {errors.confirmPassword && <p className="text-red-400 text-[10px] mt-1 ml-1">{errors.confirmPassword}</p>}
            </div>
